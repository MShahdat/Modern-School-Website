// src/Components/Others/Study.jsx
...
const Policy = () => {
  ...
  return (
    <div className='bg-white/95 dark:bg-black/80 '>
      ...
      {/* heading unchanged */}
      <h2 className='text-2xl md:text-4xl font-bold text-center mb-4 text-blue-900 dark:text-white/80'>
        Admission Policy
      </h2>
      ...
      <div className='px-4 py-8'>
        ...
        {schoolData?.admission_policies.map((it, idx) => (
          <div key={it?.id ?? idx} className="mb-8">
            ...
            {it?.description ? (
              <div
                className="richtext text-[16px] md:text-[17px] dark:text-white/90 text-gray-600"
