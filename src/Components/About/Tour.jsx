    ...
    return (
        <div className='bg-white/95 dark:bg-black/80 '>
            <div className='max-w-6xl px-4 py-8 mx-auto'>
                <h2 className='text-2xl md:text-4xl dark:text-white/90 font-bold text-center text-blue-900 mb-4'>Campus Tour</h2>
                <hr className='border-t border-2 border-black/30 dark:border-white/20 mt-2 mb-0' />
                <div className='px-8 py-8 text-[16px] md:text-[17px] text-justify text-gray-600 dark:text-white/90 tracking-wider leading-relaxed'>
